...
const theme: ThemeProps = {
  ...
  theme: {
    tab: {
      tablist: {
        tabitem: {
          base: "flex items-center justify-center px-4 py-2 rounded-t-lg text-sm font-medium first:ml-0 disabled:cursor-not-allowed disabled:text-gray-400 disabled:dark:text-gray-500 focus:ring-4 focus:ring-cyan-300 focus:outline-none"
        }
      }
    }
  }
